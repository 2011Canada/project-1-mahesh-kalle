...
xhttp.open("GET",'http://localhost:8080/ers5/html/employee.do',true); //Sends the set values 'request' to this.
xhttp.send();
}
...
function getTicketInfo(){ 
	...
	xhttp.onreadystatechange = function(){
		...
		//this goes straight to the request helper.
		xhttp.open("GET",'http://localhost:8080/ers5/html/displayTickets.do',true); //Sends the set values 'request' to this.
		xhttp.send();
}
